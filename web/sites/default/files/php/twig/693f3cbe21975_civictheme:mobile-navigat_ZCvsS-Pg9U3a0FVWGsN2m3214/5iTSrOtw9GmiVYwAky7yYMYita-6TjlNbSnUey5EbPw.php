...
($context["text"] ?? null), "icon" => "close", "icon_placement" => "after", "attributes" => CoreExtension::getAttribute($this->env, $this->source,         // line 28
($context["attributes"] ?? null), "setAttribute", ["data-flyout-close-all-trigger", ""], "method", false, false, true, 28), "modifier_class" => "ct-mobile-navigation-close__button"]));
        // line 31
        yield "</div>
";
