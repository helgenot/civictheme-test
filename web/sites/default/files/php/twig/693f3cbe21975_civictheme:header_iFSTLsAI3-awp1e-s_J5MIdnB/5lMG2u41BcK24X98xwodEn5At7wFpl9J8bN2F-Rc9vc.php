...
";
    ...
    ";
            ...
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(($context["content_bottom1"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 126
                yield "      <div class=\"ct-header__bottom\">
        ";
                // line 127
...
";
              ...
              <div class=\"row\">
                <div class=\"col-xxs-12\">
                  <div class=\"ct-header__content-top1\">
                    ";
        // line 46
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_top1"] ?? null), "html", null, true);
        yield "
                  </div>
                </div>
              </div>
    ...
    public function block_content_top2_block(array $context, array $blocks = []): iterable
    {
        ...
        yield "                <div class=\"col-xxs-12 col-m-4\">
                  <div class=\"ct-header__content-top2\">
                    ";
        // line 61
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_top2"] ?? null), "html", null, true);
        yield "
                  </div>
                </div>
              ";
    ...
    public function block_content_top3_block(array $context, array $blocks = []): iterable
    {
        ...
        yield "                <div class=\"col-xxs-12 col-m-8\">
                  <div class=\"ct-header__content-top3\">
                    ";
        // line 69
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_top3"] ?? null), "html", null, true);
        yield "
                  </div>
                </div>
              ";
              ...
              <div class=\"row\">
                <div class=\"col-xxs-12\">
                  <div class=\"ct-header__content-middle1\">
                    ";
        // line 89
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_middle1"] ?? null), "html", null, true);
        yield "
                  </div>
                </div>
              </div>
    ...
    public function block_content_middle2_block(array $context, array $blocks = []): iterable
    {
        ...
        yield "                  <div class=\"col col--no-grow\">
                    <div class=\"ct-header__content-middle2\">
                      ";
        // line 104
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_middle2"] ?? null), "html", null, true);
        yield "
                    </div>
                  </div>
                ";
    ...
    public function block_content_middle3_block(array $context, array $blocks = []): iterable
    {
        ...
        yield "                  <div class=\"col\">
                    <div class=\"ct-header__content-middle3\">
                      ";
        // line 114
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_middle3"] ?? null), "html", null, true);
        yield "
                    </div>
                  </div>
                ";
            ...
            <div class=\"row\">
              <div class=\"col-xxs-12\">
                <div class=\"ct-header__content-bottom1\">
                  ";
        // line 132
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_bottom1"] ?? null), "html", null, true);
        yield "
                </div>
              </div>
            </div>
    ...
    {
        return array (  335 => 132,  329 => 128,  322 => 127,  313 => 114,  309 => 112,  302 => 111,  293 => 104,  289 => 102,  282 => 101,  271 => 89,  265 => 85,  258 => 84,  249 => 69,  245 => 67,  238 => 66,  229 => 61,  225 => 59,  218 => 58,  207 => 46,  201 => 42,  194 => 41,  186 => 140,  182 => 138,  180 => 127,  177 => 126,  175 => 125,  172 => 124,  168 => 122,  163 => 119,  160 => 118,  157 => 111,  155 => 110,  152 => 109,  149 => 108,  146 => 101,  144 => 100,  140 => 98,  138 => 97,  135 => 96,  132 => 95,  129 => 84,  127 => 83,  123 => 81,  121 => 80,  118 => 79,  114 => 77,  108 => 73,  106 => 66,  103 => 65,  101 => 58,  96 => 55,  94 => 54,  91 => 53,  88 => 52,  85 => 41,  83 => 40,  79 => 38,  77 => 37,  67 => 35,  65 => 34,  62 => 33,  60 => 32,  58 => 31,  55 => 30,  51 => 1,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["format" => 31, "default" => 31, "escape" => 35];
        static $functions = [];
