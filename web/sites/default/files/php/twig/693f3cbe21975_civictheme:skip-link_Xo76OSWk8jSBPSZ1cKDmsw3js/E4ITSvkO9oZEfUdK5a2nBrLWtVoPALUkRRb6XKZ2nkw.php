...
($context["text"] ?? null), "attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["data-platform" => ""]), "modifier_class" => "ct-skip-link__link ct-visually-hidden"]));
            // line 30
            yield "  </div>
";
        }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["default" => 15, "format" => 16, "escape" => 20];
