...
($context["title"] ?? null), "level" => 1, "modifier_class" => "ct-banner__title"]));
    ...
    public function block_content_middle_block(array $context, array $blocks = []): iterable
    {
        ...
        // line 154
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_middle"] ?? null), "html", null, true);
        // line 155
        yield "</div>
                </div>
              ";
...
($context["featured_image"] ?? null), "alt", [], "any", false, false, true, 182), "modifier_class" => "ct-banner__featured-image"]));
    ...
    public function block_content_below_block(array $context, array $blocks = []): iterable
    {
        ...
        // line 196
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["content_below"] ?? null), "html", null, true);
        // line 197
        yield "</div>
            </div>
          ";
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["format" => 52, "default" => 52, "escape" => 56];
        static $functions = [];
