...
";
        // line 19
        yield from $this->load("civictheme:button", 19)->unwrap()->yield(CoreExtension::toArray(["theme" =>         // line 20
($context["theme"] ?? null), "kind" => "button", "icon" =>         // line 22
($context["icon"] ?? null), "icon_placement" => "after", "size" => "small", "text" =>         // line 25
($context["text"] ?? null), "modifier_class" =>         // line 26
($context["modifier_class"] ?? null), "attributes" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 27
($context["attributes"] ?? null), "setAttribute", ["data-flyout-open-trigger", ""], "method", false, false, true, 27), "setAttribute", ["data-flyout-target", ".ct-mobile-navigation"], "method", false, false, true, 27), "setAttribute", ["aria-expanded", "false"], "method", false, false, true, 27)]));
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["theme", "text"]);        yield from [];
    }
    ...
    {
        return array (  65 => 27,  64 => 26,  63 => 25,  62 => 22,  61 => 20,  60 => 19,  57 => 18,  55 => 17,  53 => 16,  51 => 15,  48 => 14,  44 => 1,);
    }
