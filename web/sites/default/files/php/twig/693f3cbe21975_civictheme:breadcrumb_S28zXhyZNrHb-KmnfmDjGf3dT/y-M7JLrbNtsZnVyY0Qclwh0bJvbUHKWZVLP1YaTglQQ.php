...
$context["loop"], "index", [], "any", false, false, true, 35) == ($context["links_count"] ?? null))) ? ($this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-current" => "location"])) : (null)), "modifier_class" => (((CoreExtension::getAttribute($this->env, $this->source,                     // line 36
...
";
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["format" => 18, "default" => 18, "length" => 22, "escape" => 25, "merge" => 52];
        static $functions = ["create_attribute" => 35];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for', 'include'],
                ['format', 'default', 'length', 'escape', 'merge'],
                ['create_attribute'],
                $this->source
            );
