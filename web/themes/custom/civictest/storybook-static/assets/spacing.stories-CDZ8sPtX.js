// phpcs:ignoreFile
import{t as c,D as y,a as l,T as p}from"./twig-TIIEE6v_.js";import"./_commonjsHelpers-_d1bhYXs.js";l(p);p.cache(!1);const i=e=>e,d=(e={})=>{const n=c.twig({id:"/var/www/html/web/themes/custom/civictest/components_combined/00-base/spacing/spacing.stories.twig",data:[{type:"raw",value:`<div class="story-container story-layout-size--large story-layout--centered">
...
`,position:{start:2350,end:2350}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),i(n.render({attributes:new y(t),...e}))}catch(t){return i("An error occurred whilst rendering /var/www/html/web/themes/custom/civictest/components_combined/00-base/spacing/spacing.stories.twig: "+t.toString())}},u={title:"Base/Spacing",component:d},s={parameters:{html:{disable:!0}}};var a,o,r;s.parameters={...s.parameters,docs:{...(a=s.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    html: {
      disable: true
    }
  }
}`,...(r=(o=s.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};const m=["Spacing"];export{s as Spacing,m as __namedExportsOrder,u as default};
