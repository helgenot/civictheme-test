// phpcs:ignoreFile
import"./checkbox-s5bXFmHL.js";import"./field-description-Ct1ZCpwf.js";import"./field-message-DdGxTmrS.js";import"./input-DCbNiGMb.js";import"./label-w8_TiyBm.js";import"./radio-DHwwdUhg.js";import"./select-BUGizy2a.js";import"./textarea-Byk0S4lb.js";import"./textfield-BVMzocDy.js";import{F as h}from"./field-DNVz5NFO.js";import{F as a}from"./field.stories.data-CYgkbsKR.js";import"./twig-TIIEE6v_.js";import"./_commonjsHelpers-_d1bhYXs.js";import"./icon-DxPaYU9_.js";import"./item-list-Zrz49Ltd.js";const M={title:"Molecules/Field",component:h,argTypes:{theme:{control:{type:"radio"},options:["light","dark"]},type:{control:{type:"select"},options:["textfield","textarea","select","select_multiple","radio","checkbox","hidden","color","date","email","file","image","month","number","password","range","search","tel","time","url","week","other"]},title:{control:{type:"text"}},title_display:{control:{type:"radio"},options:["visible","invisible","hidden"]},title_size:{control:{type:"radio"},options:["extra-small","small","regular","large","extra-large"]},description:{control:{type:"text"}},name:{control:{type:"text"}},value:{control:{type:"text"}},placeholder:{control:{type:"text"}},id:{control:{type:"text"}},is_invalid:{control:{type:"boolean"}},is_disabled:{control:{type:"boolean"}},is_required:{control:{type:"boolean"}},required_text:{control:{type:"text"}},orientation:{control:{type:"radio"},options:["vertical","horizontal"]},is_inline:{control:{type:"boolean"}},control:{control:{type:"object"}},modifier_class:{control:{type:"text"}},prefix:{control:{type:"text"}},suffix:{control:{type:"text"}}}},e={parameters:{layout:"centered"},args:a.args()},t={parameters:{layout:"centered"},args:{...a.args("light",{controls:!0,is_required:!0}),type:"radio"}},r={parameters:{layout:"centered"},args:{...a.args("light",{controls:!0,is_required:!0}),type:"checkbox"}},o={parameters:{layout:"centered"},args:{...a.args("light",{options:!0,is_required:!0}),type:"select"}};var i,s,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  parameters: {
    layout: 'centered'
  },
  args: FieldData.args()
