// phpcs:ignoreFile
import{t as o,D as r,a as p,T as s}from"./twig-TIIEE6v_.js";import"./_commonjsHelpers-_d1bhYXs.js";p(s);s.cache(!1);const a=d=>d,c=(d={})=>{const l=o.twig({id:"/var/www/html/web/themes/custom/civictest/components_combined/00-base/responsive/responsive.stories.twig",data:[{type:"raw",value:`
...
<div data-collapsible data-responsive="xl"><div>Trigger - &gt;=XL</div><div>Collapsible content</div></div>
<div data-collapsible data-responsive="xxl"><div>Trigger - &gt;=XXL</div><div>Collapsible content</div></div>
`,position:{start:52,end:52}}],precompiled:!0});l.options.allowInlineIncludes=!0;try{let i=d.defaultAttributes?d.defaultAttributes:[];return Array.isArray(i)||(i=Object.entries(i)),a(l.render({attributes:new r(i),...d}))}catch(i){return a("An error occurred whilst rendering /var/www/html/web/themes/custom/civictest/components_combined/00-base/responsive/responsive.stories.twig: "+i.toString())}},T={title:"Base/Utilities/Responsive",component:c},e={parameters:{layout:"centered",html:{disable:!0}}};var v,t,n;e.parameters={...e.parameters,docs:{...(v=e.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    layout: 'centered',
    html: {
      disable: true
...
}`,...(n=(t=e.parameters)==null?void 0:t.docs)==null?void 0:n.source}}};const X=["Responsive"];export{e as Responsive,X as __namedExportsOrder,T as default};
