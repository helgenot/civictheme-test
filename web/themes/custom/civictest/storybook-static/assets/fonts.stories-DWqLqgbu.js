// phpcs:ignoreFile
import{t as c,D as u,a as d,T as l}from"./twig-TIIEE6v_.js";import{C as s}from"./constants-DgSegUo0.js";import"./_commonjsHelpers-_d1bhYXs.js";d(l);l.cache(!1);const n=e=>e,y=(e={})=>{const i=c.twig({id:"/var/www/html/web/themes/custom/civictest/components_combined/00-base/fonts/fonts.stories.twig",data:[{type:"raw",value:`<div class="story-fonts-wrapper">
...
`,position:{start:754,end:754}}],precompiled:!0});i.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),n(i.render({attributes:new u(t),...e}))}catch(t){return n("An error occurred whilst rendering /var/www/html/web/themes/custom/civictest/components_combined/00-base/fonts/fonts.stories.twig: "+t.toString())}},f={title:"Base/Fonts",component:y,argTypes:{fonts:{table:{disable:!0}},weights:{table:{disable:!0}}}},a={parameters:{layout:"centered",html:{disable:!0}},args:{fonts:Object.keys({...s.SCSS_VARIABLES["ct-fonts-default"],...s.SCSS_VARIABLES["ct-fonts"]}),weights:Object.keys({...s.SCSS_VARIABLES["ct-font-weights-default"],...s.SCSS_VARIABLES["ct-font-weights"]})}};var o,r,p;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  parameters: {
    layout: 'centered',
    html: {
      disable: true
...
}`,...(p=(r=a.parameters)==null?void 0:r.docs)==null?void 0:p.source}}};const m=["Fonts"];export{a as Fonts,m as __namedExportsOrder,f as default};
