// phpcs:ignoreFile
import{t as i,D as p,a as d,T as c}from"./twig-TIIEE6v_.js";import"./_commonjsHelpers-_d1bhYXs.js";d(c);c.cache(!1);const o=t=>t,h=(t={})=>{const r=i.twig({id:"/var/www/html/web/themes/custom/civictest/components_combined/00-base/scrollspy/scrollspy.stories.twig",data:[{type:"raw",value:`<div class="story-container">
...
`,position:{start:0,end:0}}],precompiled:!0});r.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),o(r.render({attributes:new p(e),...t}))}catch(e){return o("An error occurred whilst rendering /var/www/html/web/themes/custom/civictest/components_combined/00-base/scrollspy/scrollspy.stories.twig: "+e.toString())}},w={title:"Base/Utilities/Scrollspy",component:h},s={parameters:{layout:"fullscreen",docs:"Scroll the viewport to see elements appear when it reaches a specific pixel threshold.",html:{disable:!0}}};var a,l,n;s.parameters={...s.parameters,docs:{...(a=s.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    layout: 'fullscreen',
...
}`,...(n=(l=s.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};const y=["Scrollspy"];export{s as Scrollspy,y as __namedExportsOrder,w as default};
